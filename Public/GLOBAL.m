...
% Copyright (c) 2016-2017 BIMK Group
    ...
    methods
        ...
        %   objective values or constraint values of the parents, since the
        %   parent objects contain only decision variables.
        %
        %   Example:
        ...
        function set.N(obj,value)
            if ~isempty(value)
                obj.Validation(value,'int','size of population ''-N''',2);
                obj.N = value;
            end
        end
        ...
        function set.D(obj,value)
            obj.D = obj.Set('D',value,'int','number of variables ''-D''',2);
        end
